...
void readInstr(int instr, unsigned char hexdump[], int addrStrtab, int namePositionTxtSymbls[], int addrIdx, int qtSymbls)
{
    ...
    switch (opA)
    {
        ...
        case(0b0001111):
            if ((((instr >> 7) & 0b11111) == 0b00000) && (((instr >> 15) & 0b11111) == 0b00000) && (((instr >> 28) & 0b1111) == 0b0000))
            {
                switch (opB)
                {
                    case (0b000):
        ...
        case(0b1110011):
            ...
            {
                case (0b000):
                    if (((instr >> 7) & 0b1111111111111) == 0b0000000000000)
                    {
                        switch (opC)
                        {
                            case (0b000000000000):
...
int main()
{
    ...
    int fd = open("bin/test-40.x", O_RDONLY);
    if (fd == -1) return -1;
